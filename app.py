...
DIRECTORY = [
    ...
    {"name": "swarmtrade (a2a-hub by tjcrowley)", "url": "https://swarmtrade.store",
     "source": "https://github.com/tjcrowley/a2a-hub",
     "desc": "peer agent marketplace with escrow, negotiation and reputation; on-chain settlement (EVM)",
     "tags": ["marketplace", "escrow", "reputation"]},
